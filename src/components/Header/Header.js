        ...
        <div className="header-wraper" id="homepage">
            <div className="main-info vertical-center">
                ...
                <div className="typed-css">
                  <h1 ref={el} className="typed-css"></h1>
                </div>
                <p></p>
                <div className="socialmedialinks">    
                    ...
                    <ul className="ul-css">
                        ...
                        <li className=" linksocial"><a target="_blank" href="https://www.figma.com/proto/ZxJyGeMCFJAOAYQrFBsbDK/Mansi-UXD-Portfolio?page-id=0%3A1&node-id=0%3A4&viewport=241%2C48%2C0.42&scaling=min-zoom">
