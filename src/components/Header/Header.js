    ...
    return (
        <div className="header-wraper" id="homepage">
            <div className="main-info vertical-center">
                <h1 className="endtext">Hi! I am Mansi <img src="https://img.icons8.com/emoji/24/000000/waving-hand-emoji.png" alt="project"/></h1>
                ...
                <div className="socialmedialinks">    
                    <nav aria-label="">
                    <ul className="ul-css">
                    <li className=" linksocial"><a target='blank' href="https://www.figma.com/proto/ZxJyGeMCFJAOAYQrFBsbDK/Mansi-UXD-Portfolio?page-id=0%3A1&node-id=0%3A4&viewport=241%2C48%2C0.42&scaling=min-zoom">Design Portfolio</a></li>
                        <li className="linksocial"><a href="https://www.linkedin.com/in/sundriyalm/"> 
                        ...
                        <li className=" linksocial"><a href="https://github.com/sundriyalmansi">
